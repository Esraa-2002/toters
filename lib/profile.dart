...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
    Text("esraa talaa",style: TextStyle(color: Colors.black,fontSize: 23,fontWeight: FontWeight.bold),),
    SizedBox(width: 5,),
    Icon(Icons.face_retouching_natural_rounded,color: Colors.black,size: 30,),
    ],
    ) ,
    ),
    ...
    SizedBox(height: 5,),
    Text(
      "Profile",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.normal),),
      ],
    ),
    ),
      Container(
